    ...
    <>
      ...
      <div className="shadow w-full h-[80px] flex items-center justify-center">
        <MaterialNavbar className="shadow-none mx-auto max-w-screen-2xl h-[80px] px-0">
          <div className="flex items-center justify-between gap-4 text-blue-gray-900 w-full px-4">
            ...
            <div className="ml-auto flex gap-4">
              <Button
                className="flex min-w-[170px] items-center justify-center gap-2 bg-blue-500 shadow-blue-100 hover:shadow-blue-300"
